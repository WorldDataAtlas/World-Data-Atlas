...
"""
👶 South America's fertility has changed dramatically over the past decades.

Watch how the ranking of South American countries by fertility rate evolves from 1950 to 2050, including UN projections.

Source: United Nations | #WorldDataAtlas
"""

TOP_N = 10
FILE_NAME = "south_america_fertility_race.mp4"
TITLE = "Fertility Rate"
SUBTITLE = "Top 10 South American countries, children per woman, 1950–2030"
FOOTER_LEFT = "Medium variant projection after 2024"
...
WHERE AA.[indicator_id] = 19 AND AA.[variant_id] = 4 AND AA.[sex_id] = 3 AND AA.[iso3_code] IN ('ARG','BOL','BRA','CHL','COL','ECU','GUY','PRY','PER','SUR','URY','VEN')
ORDER BY AA.[year]
"""
