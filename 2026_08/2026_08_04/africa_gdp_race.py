...
"""
📈 How has Africa's economic landscape changed over the past six decades?

Watch the Top 10 African economies by GDP evolve from 1960 to 2024.
...
TOP_N = 10
FILE_NAME = "africa_gdp_race.mp4"
TITLE = "Gross Domestic Product (GDP)"
SUBTITLE = "Top 10 African economies, current US$, 1960–2024"
FOOTER_LEFT = "Gross domestic product (current US$)"
...
WHERE [indicator_code] = 'NY.GDP.MKTP.CD' AND [country_code] IN (
