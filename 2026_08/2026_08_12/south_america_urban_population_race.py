...
"""
🏙️ South America is one of the world's most urbanized regions.

Watch how the share of people living in urban areas has evolved across South American countries from 1960 to 2024.

Source: World Bank (UN Population Division) | #WorldDataAtlas
"""

TOP_N = 10
FILE_NAME = "south_america_urban_population_race.mp4"
TITLE = "Urban Population"
SUBTITLE = "Top 10 South American countries, share of population living in urban areas, 1960–2024"
FOOTER_LEFT = "Urban population (% of total population)"
FOOTER_RIGHT = "Source: World Bank (UN Population Division)"
TIME_COL = "year"
CATEGORY_COL = "country_code"
VALUE_COL = "value"
LABEL_COL = "country_name"
FLAG_COL = "country_id"
X_LABEL = "Percent of population"
...
WHERE [indicator_code] = 'SP.URB.TOTL.IN.ZS' AND [country_code] IN ('ARG','BOL','BRA','CHL','COL','ECU','GUY','PRY','PER','SUR','URY','VEN')
ORDER BY [year] DESC
"""
