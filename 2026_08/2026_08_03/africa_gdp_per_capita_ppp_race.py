...
"""
💰 Which African countries have seen the biggest gains in living standards?

Watch the Top 10 African countries by GDP per capita (PPP) from 1990 to 2024.
...
TOP_N = 10
FILE_NAME = "africa_gdp_per_capita_ppp_race.mp4"
TITLE = "GDP per Capita (PPP)"
SUBTITLE = "Top 10 African countries, International dollars (current PPP), 1990–2024"
...
WHERE [indicator_code] = 'NY.GDP.PCAP.PP.CD' AND [country_code] IN (
