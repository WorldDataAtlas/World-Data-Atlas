...
"""
🎓 How much do governments invest in education?

This chart compares government expenditure on education as a share of GDP across the European Union, the Arab World, Latin America & Caribbean, China and India.
...
WHERE [indicator_code] = 'SE.XPD.TOTL.GD.ZS' and [country_id] IN ('EU', '1A', 'XJ','CN','IN')
ORDER BY [year] DESC
        """

MAP_TITLE = "Government Expenditure on Education"
MAP_SUBTITLE = "Government spending on education as a share of GDP"
MAP_SOURCE = "World Bank"
FILE_NAME = "government_education_expenditure_gdp_regions.png"
FOOTER_LEFT = "Government expenditure on education (% of GDP)"
