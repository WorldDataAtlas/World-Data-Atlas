...
"""🌎 South America's population has more than doubled since 1950—and the demographic balance continues to evolve.

Watch the Top 10 most populous South American countries from 1950 to 2030, including UN projections.

Source: United Nations | #WorldDataAtlas"""


TOP_N = 10
FILE_NAME = "south_america_population_1950_2030_race.mp4"
TITLE = "Population of South America"
SUBTITLE = "Top 10 most populous South American countries, 1950–2030"
...
WHERE AA.[indicator_id] = 49 AND AA.[variant_id] = 4 AND AA.[sex_id] = 3 AND AA.[iso3_code] IN ('ARG','BOL','BRA','CHL','COL','ECU','GUY','PRY','PER','SUR','URY','VEN')
ORDER BY AA.[year]
"""
