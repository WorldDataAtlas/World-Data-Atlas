...
"""The world's population story in one chart.

From the rise of China to India's recent takeover as the most populous country, the global ranking has changed dramatically over the decades.

Data: UN World Population Prospects

#DataViz #Population #Demographics #DataScience #Statistics #WorldDataAtlas
"""

TOP_N = 10
FILE_NAME = "population_bar_race.mp4"
TITLE = "World Population Ranking Over Time"
SUBTITLE = "Top 10 countries by total population"
FOOTER_LEFT = "Population, both sexes, all ages"
...
query = """
    ...
    LEFT JOIN (     SELECT [wb_id],[iso2_code],[name],[is_country]
                    ...
                    WHERE [is_country] = 1) AS ENT ON ENT.[wb_id] = D.[iso3_code]
    WHERE D.indicator_id = 49 AND D.[variant_id] = 4 AND D.[sex_id] = 3 AND ENT.[is_country] = 1
