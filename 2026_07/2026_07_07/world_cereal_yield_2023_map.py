...
"""
High cereal yields don't always mean large agricultural production.

Countries like Egypt achieve very high yields thanks to intensive irrigation and farming on relatively small harvested areas.

🌾 Yield = productivity, not production.

#Agriculture #DataViz #WorldDataAtlas
"""
...
query = """
        ...
        WHERE AA.[indicator_code] = 'AG.YLD.CREL.KG' AND ENT.is_country = 1 AND AA.[year] = 2023
        """
MAP_TITLE = "Cereal Yield Around the World"
MAP_SUBTITLE = "Kilograms of cereal produced per hectare of harvested land, 2023"
MAP_SOURCE = "Source: World Bank"
FILE_NAME = "world_cereal_yield_2023.png"
LEGEND_MIN = 0
LEGEND_MAX = 10000
COLOR_SCALE_LOW = "#FF0000"
COLOR_SCALE_HIGH = "#16A34A"
CONTINENT = None
MAP_X_LIMITS = None
MAP_Y_LIMITS = None
