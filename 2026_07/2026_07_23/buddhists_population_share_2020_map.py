...
"""
☸️ Where is Buddhism most prevalent?

This map shows the share of the population identifying as Buddhist in each country in 2020.
...
query = """
        WITH buddhists AS (
                SELECT
                        ...
                        AG.population,
                        AG.buddhists,
                        ROUND(AG.buddhists * 100.0 / NULLIF(AG.population, 0), 2) AS buddhists_pct
        ...
        SELECT
                country_code,
                country,
                buddhists_pct as value
        FROM buddhists
        ORDER BY buddhists_pct DESC;
        """

MAP_TITLE = "Buddhists Population by Country"
MAP_SUBTITLE = "Share of the population identifying as buddhist, 2020"
MAP_SOURCE = "Pew Research Center"
FILE_NAME = "buddhists_population_share_2020.png"
LEGEND_MIN = 0
LEGEND_MAX = 100
