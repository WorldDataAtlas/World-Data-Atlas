...
"""One of the clearest relationships in global demography.

Higher contraceptive use is generally associated with lower fertility.

Contraceptive prevalence vs. total fertility rate, 2025.
...
query = """
    ...
    LEFT JOIN ( 
                ...
                WHERE [indicator_id] = 19 AND [year] = 2025 AND [variant_id] = 4) AS FER ON FER.[iso2_code] = AA.[iso2_code]
    WHERE   AA.indicator_id = 1 and 
            ...
            FER.[value] is not null
        """

FILE_NAME = "contraceptive_prevalence_vs_fertility_2025.png"
X_COL = "CON"
Y_COL = "FER"
MAP_TITLE = "Contraceptive Use vs Fertility"
MAP_SUBTITLE = "Share of women aged 15–49 using any method of contraception and births per woman, 2025"
X_LABEL = "Contraceptive prevalence, any method (%)"
Y_LABEL = "Total fertility rate (births per woman)"
