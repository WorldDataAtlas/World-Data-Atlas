...
"""
🌍 Where are the most religiously unaffiliated people?

This map shows the share of the population identifying with no religion in each country in 2020.
...
query = """
        ...
        SELECT
                ...
                unaffiliated_pct as value
        FROM unaffiliated
        ORDER BY unaffiliated_pct DESC;
        """

MAP_TITLE = "Population with No Religious Affiliation"
MAP_SUBTITLE = "Share of the population identifying with no religion, 2020"
