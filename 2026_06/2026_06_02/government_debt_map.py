...
for year in range(1990,2032):
        ...
        WHERE d.dataflow_id = 'WEO'
                AND d.indicator = 'GGXWDG_NGDP'
                AND LEN(d.country) = 3
                AND d.[year] = """+str(year)+"""
        """

        MAP_TITLE = 'Gross Government Debt in Europe (% of GDP)'
        MAP_SUBTITLE = 'Year: ' + str(year)
        MAP_SOURCE = 'Source: IMF World Economic Outlook (WEO)'

        FILE_NAME = 'weo_government_debt_europe_' + str(year) + '.png'
        ...
        CONTINENT = None
        MAP_X_LIMITS = (-1800000, 4000000)
        MAP_Y_LIMITS = (3200000, 7670000)
