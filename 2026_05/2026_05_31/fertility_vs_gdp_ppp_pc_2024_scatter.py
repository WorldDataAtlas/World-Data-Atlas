...
WHERE D.[indicator_code] = 'NY.GDP.PCAP.PP.KD' AND ENT.[name] IS NOT NULL AND FER.[FERTILITY] IS NOT NULL AND
      D.[year] = 2024
"""

FILE_NAME = "fertility_vs_gdp_ppp_pc_2024"
X_COL = "GDP_PPP_pc"
Y_COL = "FERTILITY"
MAP_TITLE = "Fertility and Prosperity"
MAP_SUBTITLE = "Countries by GDP per capita (PPP) and fertility rate, 2024"
X_LABEL = "GDP per capita, PPP (constant 2021 international $)"
Y_LABEL = "Fertility rate (births per woman)"
FOOTER_LEFT = "Metric: GDP per capita, PPP (constant 2021 international $) vs. fertility rate (births per woman)"
FOOTER_RIGHT = "Source: World Bank"
POINT_COLOR = "#00FF04"
SHOW_LABELS = True
COLOR_COL = None
POINT_EDGE_WIDTH = 0.2
POINT_SIZE = 40
X_LOG = True
Y_LOG = False
